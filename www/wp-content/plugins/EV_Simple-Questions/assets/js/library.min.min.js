...
/*!
     ...
     */
(function(b){if(typeof define==="function"&&define.amd){define(["jquery"],b)}else{if(typeof exports==="object"){module.exports=b}else{b(jQuery)}}}(function(t){var s=["wheel","mousewheel","DOMMouseScroll","MozMousePixelScroll"],m=("onwheel" in document||document.documentMode>=9)?["wheel"]:["mousewheel","DomMouseScroll","MozMousePixelScroll"],o=Array.prototype.slice,n,u;if(t.event.fixHooks){for(var r=s.length;r;){t.event.fixHooks[s[--r]]=t.event.mouseHooks}}var q=t.event.special.mousewheel={version:"3.1.12",setup:function(){if(this.addEventListener){for(var a=m.length;a;){this.addEventListener(m[--a],i,false)}}else{this.onmousewheel=i}t.data(this,"mousewheel-line-height",q.getLineHeight(this));t.data(this,"mousewheel-page-height",q.getPageHeight(this))},teardown:function(){if(this.removeEventListener){for(var a=m.length;a;){this.removeEventListener(m[--a],i,false)}}else{this.onmousewheel=null}t.removeData(this,"mousewheel-line-height");t.removeData(this,"mousewheel-page-height")},getLineHeight:function(a){var b=t(a),c=b["offsetParent" in t.fn?"offsetParent":"parent"]();if(!c.length){c=t("body")}return parseInt(c.css("fontSize"),10)||parseInt(b.css("fontSize"),10)||16},getPageHeight:function(a){return t(a).height()},settings:{adjustOldDeltas:true,normalizeOffset:true}};t.fn.extend({mousewheel:function(a){return a?this.bind("mousewheel",a):this.trigger("mousewheel")},unmousewheel:function(a){return this.unbind("mousewheel",a)}});function i(g){var d=g||window.event,k=o.call(arguments,1),h=0,b=0,c=0,l=0,x=0,a=0;g=t.event.fix(d);g.type="mousewheel";if("detail" in d){c=d.detail*-1}if("wheelDelta" in d){c=d.wheelDelta}if("wheelDeltaY" in d){c=d.wheelDeltaY}if("wheelDeltaX" in d){b=d.wheelDeltaX*-1}if("axis" in d&&d.axis===d.HORIZONTAL_AXIS){b=c*-1;c=0}h=c===0?b:c;if("deltaY" in d){c=d.deltaY*-1;h=c}if("deltaX" in d){b=d.deltaX;if(c===0){h=b*-1}}if(c===0&&b===0){return}if(d.deltaMode===1){var j=t.data(this,"mousewheel-line-height");h*=j;c*=j;b*=j}else{if(d.deltaMode===2){var e=t.data(this,"mousewheel-page-height");h*=e;c*=e;b*=e}}l=Math.max(Math.abs(c),Math.abs(b));if(!u||l<u){u=l;if(v(d,l)){u/=40}}if(v(d,l)){h/=40;b/=40;c/=40}h=Math[h>=1?"floor":"ceil"](h/u);b=Math[b>=1?"floor":"ceil"](b/u);c=Math[c>=1?"floor":"ceil"](c/u);if(q.settings.normalizeOffset&&this.getBoundingClientRect){var f=this.getBoundingClientRect();x=g.clientX-f.left;a=g.clientY-f.top}g.deltaX=b;g.deltaY=c;g.deltaFactor=u;g.offsetX=x;g.offsetY=a;g.deltaMode=0;k.unshift(g,h,b,c);if(n){clearTimeout(n)}n=setTimeout(p,200);return(t.event.dispatch||t.event.handle).apply(this,k)}function p(){u=null}function v(a,b){return q.settings.adjustOldDeltas&&a.type==="mousewheel"&&b%120===0}}));!function(a){"function"==typeof define&&define.amd?define(["jquery"],a):"object"==typeof exports?module.exports=a(require("jquery")):a(jQuery)}(function(a){a.fn.jScrollPane=function(b){function c(ai,aj){function ak(aG){var aH,aI,aA,aB,aC,aD,aE=!1,aF=!1;if(aY=aG,void 0===aZ){aC=ai.scrollTop(),aD=ai.scrollLeft(),ai.css({overflow:"hidden",padding:0}),d=ai.innerWidth()+e,W=ai.innerHeight(),ai.width(d),aZ=a('<div class="jspPane" />').css("padding",R).append(ai.children()),X=a('<div class="jspContainer" />').css({width:d+"px",height:W+"px"}).append(aZ).appendTo(ai)}else{if(ai.css("width",""),aE=aY.stickToBottom&&o(),aF=aY.stickToRight&&q(),aB=ai.innerWidth()+e!=d||ai.outerHeight()!=W,aB&&(d=ai.innerWidth()+e,W=ai.innerHeight(),X.css({width:d+"px",height:W+"px"})),!aB&&i==Y&&aZ.outerHeight()==Z){return void ai.width(d)}i=Y,aZ.css("width",""),ai.width(d),X.find(">.jspVerticalBar,>.jspHorizontalBar").remove().end()}aZ.css("overflow","auto"),Y=aG.contentWidth?aG.contentWidth:aZ[0].scrollWidth,Z=aZ[0].scrollHeight,aZ.css("overflow",""),aa=Y/d,ab=Z/W,ac=ab>1,ad=aa>1,ad||ac?(ai.addClass("jspScrollable"),aH=aY.maintainPosition&&(j||V),aH&&(aI=K(),aA=L()),am(),ao(),aq(),aH&&(I(aF?Y-d:aI,!1),H(aE?Z-W:aA,!1)),v(),r(),aW(),aY.enableKeyboardNavigation&&aw(),aY.clickOnTrack&&x(),ay(),aY.hijackInternalLinks&&aV()):(ai.removeClass("jspScrollable"),aZ.css({top:0,left:0,width:X.width()-e}),s(),w(),ax(),y()),aY.autoReinitialise&&!N?N=setInterval(function(){ak(aY)},aY.autoReinitialiseDelay):!aY.autoReinitialise&&N&&clearInterval(N),aC&&ai.scrollTop(0)&&H(aC,!1),aD&&ai.scrollLeft(0)&&I(aD,!1),ai.trigger("jsp-initialised",[ad||ac])}function am(){ac&&(X.append(a('<div class="jspVerticalBar" />').append(a('<div class="jspCap jspCapTop" />'),a('<div class="jspTrack" />').append(a('<div class="jspDrag" />').append(a('<div class="jspDragTop" />'),a('<div class="jspDragBottom" />'))),a('<div class="jspCap jspCapBottom" />'))),z=X.find(">.jspVerticalBar"),P=z.find(">.jspTrack"),ae=P.find(">.jspDrag"),aY.showArrows&&(az=a('<a class="jspArrow jspArrowUp" />').bind("mousedown.jsp",au(0,-1)).bind("click.jsp",t),ar=a('<a class="jspArrow jspArrowDown" />').bind("mousedown.jsp",au(0,1)).bind("click.jsp",t),aY.arrowScrollOnHover&&(az.bind("mouseover.jsp",au(0,-1,az)),ar.bind("mouseover.jsp",au(0,1,ar))),at(P,aY.verticalArrowPositions,az,ar)),g=W,X.find(">.jspVerticalBar>.jspCap:visible,>.jspVerticalBar>.jspArrow").each(function(){g-=a(this).outerHeight()}),ae.hover(function(){ae.addClass("jspHover")},function(){ae.removeClass("jspHover")}).bind("mousedown.jsp",function(aB){a("html").bind("dragstart.jsp selectstart.jsp",t),ae.addClass("jspActive");var aA=aB.pageY-ae.position().top;return a("html").bind("mousemove.jsp",function(aC){B(aC.pageY-aA,!1)}).bind("mouseup.jsp mouseleave.jsp",A),!1}),an())}function an(){P.height(g+"px"),j=0,T=aY.verticalGutter+P.outerWidth(),aZ.width(d-T-e);try{0===z.position().left&&aZ.css("margin-left",T+"px")}catch(aA){}}function ao(){ad&&(X.append(a('<div class="jspHorizontalBar" />').append(a('<div class="jspCap jspCapLeft" />'),a('<div class="jspTrack" />').append(a('<div class="jspDrag" />').append(a('<div class="jspDragLeft" />'),a('<div class="jspDragRight" />'))),a('<div class="jspCap jspCapRight" />'))),O=X.find(">.jspHorizontalBar"),S=O.find(">.jspTrack"),ag=S.find(">.jspDrag"),aY.showArrows&&(u=a('<a class="jspArrow jspArrowLeft" />').bind("mousedown.jsp",au(-1,0)).bind("click.jsp",t),al=a('<a class="jspArrow jspArrowRight" />').bind("mousedown.jsp",au(1,0)).bind("click.jsp",t),aY.arrowScrollOnHover&&(u.bind("mouseover.jsp",au(-1,0,u)),al.bind("mouseover.jsp",au(1,0,al))),at(S,aY.horizontalArrowPositions,u,al)),ag.hover(function(){ag.addClass("jspHover")},function(){ag.removeClass("jspHover")}).bind("mousedown.jsp",function(aB){a("html").bind("dragstart.jsp selectstart.jsp",t),ag.addClass("jspActive");var aA=aB.pageX-ag.position().left;return a("html").bind("mousemove.jsp",function(aC){D(aC.pageX-aA,!1)}).bind("mouseup.jsp mouseleave.jsp",A),!1}),f=X.innerWidth(),ap())}function ap(){X.find(">.jspHorizontalBar>.jspCap:visible,>.jspHorizontalBar>.jspArrow").each(function(){f-=a(this).outerWidth()}),S.width(f+"px"),V=0}function aq(){if(ad&&ac){var aB=S.outerHeight(),aA=P.outerWidth();g-=aB,a(O).find(">.jspCap:visible,>.jspArrow").each(function(){f+=a(this).outerWidth()}),f-=aA,W-=aA,d-=aB,S.parent().append(a('<div class="jspCorner" />').css("width",aB+"px")),an(),ap()}ad&&aZ.width(X.outerWidth()-e+"px"),Z=aZ.outerHeight(),ab=Z/W,ad&&(k=Math.ceil(1/aa*f),k>aY.horizontalDragMaxWidth?k=aY.horizontalDragMaxWidth:k<aY.horizontalDragMinWidth&&(k=aY.horizontalDragMinWidth),ag.width(k+"px"),m=f-k,E(V)),ac&&(l=Math.ceil(1/ab*g),l>aY.verticalDragMaxHeight?l=aY.verticalDragMaxHeight:l<aY.verticalDragMinHeight&&(l=aY.verticalDragMinHeight),ae.height(l+"px"),af=g-l,C(j))}function at(aE,aF,aG,aA){var aB,aC="before",aD="after";"os"==aF&&(aF=/Mac/.test(navigator.platform)?"after":"split"),aF==aC?aD=aF:aF==aD&&(aC=aF,aB=aG,aG=aA,aA=aB),aE[aC](aG)[aD](aA)}function au(aB,aC,aA){return function(){return av(aB,aC,this,aA),this.blur(),!1}}function av(aD,aE,aF,aG){aF=a(aF).addClass("jspActive");var aH,aA,aB=!0,aC=function(){0!==aD&&p.scrollByX(aD*aY.arrowButtonSpeed),0!==aE&&p.scrollByY(aE*aY.arrowButtonSpeed),aA=setTimeout(aC,aB?aY.initialDelay:aY.arrowRepeatFreq),aB=!1};aC(),aH=aG?"mouseout.jsp":"mouseup.jsp",aG=aG||a("html"),aG.bind(aH,function(){aF.removeClass("jspActive"),aA&&clearTimeout(aA),aA=null,aG.unbind(aH)})}function x(){y(),ac&&P.bind("mousedown.jsp",function(aD){if(void 0===aD.originalTarget||aD.originalTarget==aD.currentTarget){var aE,aF=a(this),aG=aF.offset(),aH=aD.pageY-aG.top-j,aA=!0,aB=function(){var aL=aF.offset(),aI=aD.pageY-aL.top-l/2,aJ=W*aY.scrollPagePercent,aK=af*aJ/(Z-W);if(0>aH){j-aK>aI?p.scrollByY(-aJ):B(aI)}else{if(!(aH>0)){return void aC()}aI>j+aK?p.scrollByY(aJ):B(aI)}aE=setTimeout(aB,aA?aY.initialDelay:aY.trackClickRepeatFreq),aA=!1},aC=function(){aE&&clearTimeout(aE),aE=null,a(document).unbind("mouseup.jsp",aC)};return aB(),a(document).bind("mouseup.jsp",aC),!1}}),ad&&S.bind("mousedown.jsp",function(aD){if(void 0===aD.originalTarget||aD.originalTarget==aD.currentTarget){var aE,aF=a(this),aG=aF.offset(),aH=aD.pageX-aG.left-V,aA=!0,aB=function(){var aL=aF.offset(),aI=aD.pageX-aL.left-k/2,aJ=d*aY.scrollPagePercent,aK=m*aJ/(Y-d);if(0>aH){V-aK>aI?p.scrollByX(-aJ):D(aI)}else{if(!(aH>0)){return void aC()}aI>V+aK?p.scrollByX(aJ):D(aI)}aE=setTimeout(aB,aA?aY.initialDelay:aY.trackClickRepeatFreq),aA=!1},aC=function(){aE&&clearTimeout(aE),aE=null,a(document).unbind("mouseup.jsp",aC)};return aB(),a(document).bind("mouseup.jsp",aC),!1}})}function y(){S&&S.unbind("mousedown.jsp"),P&&P.unbind("mousedown.jsp")}function A(){a("html").unbind("dragstart.jsp selectstart.jsp mousemove.jsp mouseup.jsp mouseleave.jsp"),ae&&ae.removeClass("jspActive"),ag&&ag.removeClass("jspActive")}function B(aD,aE){if(ac){0>aD?aD=0:aD>af&&(aD=af);var aF=new a.Event("jsp-will-scroll-y");if(ai.trigger(aF,[aD]),!aF.isDefaultPrevented()){var aG=aD||0,aH=0===aG,aA=aG==af,aB=aD/af,aC=-aB*(Z-W);void 0===aE&&(aE=aY.animateScroll),aE?p.animate(ae,"top",aD,C,function(){ai.trigger("jsp-user-scroll-y",[-aC,aH,aA])}):(ae.css("top",aD),C(aD),ai.trigger("jsp-user-scroll-y",[-aC,aH,aA]))}}}function C(aE){void 0===aE&&(aE=ae.position().top),X.scrollTop(0),j=aE||0;var aA=0===j,aB=j==af,aC=aE/af,aD=-aC*(Z-W);(ah!=aA||Q!=aB)&&(ah=aA,Q=aB,ai.trigger("jsp-arrow-change",[ah,Q,M,U])),F(aA,aB),aZ.css("top",aD),ai.trigger("jsp-scroll-y",[-aD,aA,aB]).trigger("scroll")}function D(aD,aE){if(ad){0>aD?aD=0:aD>m&&(aD=m);var aF=new a.Event("jsp-will-scroll-x");if(ai.trigger(aF,[aD]),!aF.isDefaultPrevented()){var aG=aD||0,aH=0===aG,aA=aG==m,aB=aD/m,aC=-aB*(Y-d);void 0===aE&&(aE=aY.animateScroll),aE?p.animate(ag,"left",aD,E,function(){ai.trigger("jsp-user-scroll-x",[-aC,aH,aA])}):(ag.css("left",aD),E(aD),ai.trigger("jsp-user-scroll-x",[-aC,aH,aA]))}}}function E(aE){void 0===aE&&(aE=ag.position().left),X.scrollTop(0),V=aE||0;var aA=0===V,aB=V==m,aC=aE/m,aD=-aC*(Y-d);(M!=aA||U!=aB)&&(M=aA,U=aB,ai.trigger("jsp-arrow-change",[ah,Q,M,U])),G(aA,aB),aZ.css("left",aD),ai.trigger("jsp-scroll-x",[-aD,aA,aB]).trigger("scroll")}function F(aA,aB){aY.showArrows&&(az[aA?"addClass":"removeClass"]("jspDisabled"),ar[aB?"addClass":"removeClass"]("jspDisabled"))}function G(aA,aB){aY.showArrows&&(u[aA?"addClass":"removeClass"]("jspDisabled"),al[aB?"addClass":"removeClass"]("jspDisabled"))}function H(aB,aC){var aA=aB/(Z-W);B(aA*af,aC)}function I(aB,aC){var aA=aB/(Y-d);D(aA*m,aC)}function J(aO,aB,aD){var aE,aF,aG,aH,aI,aJ,aK,aL,aM,aN=0,aA=0;try{aE=a(aO)}catch(aC){return}for(aF=aE.outerHeight(),aG=aE.outerWidth(),X.scrollTop(0),X.scrollLeft(0);!aE.is(".jspPane");){if(aN+=aE.position().top,aA+=aE.position().left,aE=aE.offsetParent(),/^body|html$/i.test(aE[0].nodeName)){return}}aH=L(),aJ=aH+W,aH>aN||aB?aL=aN-aY.horizontalGutter:aN+aF>aJ&&(aL=aN-W+aF+aY.horizontalGutter),isNaN(aL)||H(aL,aD),aI=K(),aK=aI+d,aI>aA||aB?aM=aA-aY.horizontalGutter:aA+aG>aK&&(aM=aA-d+aG+aY.horizontalGutter),isNaN(aM)||I(aM,aD)}function K(){return -aZ.position().left}function L(){return -aZ.position().top}function o(){var aA=Z-W;return aA>20&&aA-L()<10}function q(){var aA=Y-d;return aA>20&&aA-K()<10}function r(){X.unbind(n).bind(n,function(aE,aF,aG,aA){V||(V=0),j||(j=0);var aB=V,aC=j,aD=aE.deltaFactor||aY.mouseWheelSpeed;return p.scrollBy(aG*aD,-aA*aD,!1),aB==V&&aC==j})}function s(){X.unbind(n)}function t(){return !1}function v(){aZ.find(":input,a").unbind("focus.jsp").bind("focus.jsp",function(aA){J(aA.target,!1)})}function w(){aZ.find(":input,a").unbind("focus.jsp")}function aw(){function aA(){var aE=V,aF=j;switch(aB){case 40:p.scrollByY(aY.keyboardSpeed,!1);break;case 38:p.scrollByY(-aY.keyboardSpeed,!1);break;case 34:case 32:p.scrollByY(W*aY.scrollPagePercent,!1);break;case 33:p.scrollByY(-W*aY.scrollPagePercent,!1);break;case 39:p.scrollByX(aY.keyboardSpeed,!1);break;case 37:p.scrollByX(-aY.keyboardSpeed,!1)}return aC=aE!=V||aF!=j}var aB,aC,aD=[];ad&&aD.push(O[0]),ac&&aD.push(z[0]),aZ.bind("focus.jsp",function(){ai.focus()}),ai.attr("tabindex",0).unbind("keydown.jsp keypress.jsp").bind("keydown.jsp",function(aG){if(aG.target===this||aD.length&&a(aG.target).closest(aD).length){var aE=V,aF=j;switch(aG.keyCode){case 40:case 38:case 34:case 32:case 33:case 39:case 37:aB=aG.keyCode,aA();break;case 35:H(Z-W),aB=null;break;case 36:H(0),aB=null}return aC=aG.keyCode==aB&&aE!=V||aF!=j,!aC}}).bind("keypress.jsp",function(aE){return aE.keyCode==aB&&aA(),aE.target===this||aD.length&&a(aE.target).closest(aD).length?!aC:void 0}),aY.hideFocus?(ai.css("outline","none"),"hideFocus" in X[0]&&ai.attr("hideFocus",!0)):(ai.css("outline",""),"hideFocus" in X[0]&&ai.attr("hideFocus",!1))}function ax(){ai.attr("tabindex","-1").removeAttr("tabindex").unbind("keydown.jsp keypress.jsp"),aZ.unbind(".jsp")}function ay(){if(location.hash&&location.hash.length>1){var aD,aA,aB=escape(location.hash.substr(1));try{aD=a("#"+aB+', a[name="'+aB+'"]')}catch(aC){return}aD.length&&aZ.find(aB)&&(0===X.scrollTop()?aA=setInterval(function(){X.scrollTop()>0&&(J(aD,!0),a(document).scrollTop(X.position().top),clearInterval(aA))},50):(J(aD,!0),a(document).scrollTop(X.position().top)))}}function aV(){a(document.body).data("jspHijack")||(a(document.body).data("jspHijack",!0),a(document.body).delegate('a[href*="#"]',"click",function(aH){var aI,aJ,aA,aB,aC,aD,aE=this.href.substr(0,this.href.indexOf("#")),aF=location.href;if(-1!==location.href.indexOf("#")&&(aF=location.href.substr(0,location.href.indexOf("#"))),aE===aF){aI=escape(this.href.substr(this.href.indexOf("#")+1));try{aJ=a("#"+aI+', a[name="'+aI+'"]')}catch(aG){return}aJ.length&&(aA=aJ.closest(".jspScrollable"),aB=aA.data("jsp"),aB.scrollToElement(aJ,!0),aA[0].scrollIntoView&&(aC=a(window).scrollTop(),aD=aJ.offset().top,(aC>aD||aD>aC+a(window).height())&&aA[0].scrollIntoView()),aH.preventDefault())}}))}function aW(){var aE,aF,aA,aB,aC,aD=!1;X.unbind("touchstart.jsp touchmove.jsp touchend.jsp click.jsp-touchclick").bind("touchstart.jsp",function(aG){var aH=aG.originalEvent.touches[0];aE=K(),aF=L(),aA=aH.pageX,aB=aH.pageY,aC=!1,aD=!0}).bind("touchmove.jsp",function(aG){if(aD){var aH=aG.originalEvent.touches[0],aI=V,aJ=j;return p.scrollTo(aE+aA-aH.pageX,aF+aB-aH.pageY),aC=aC||Math.abs(aA-aH.pageX)>5||Math.abs(aB-aH.pageY)>5,aI==V&&aJ==j}}).bind("touchend.jsp",function(){aD=!1}).bind("click.jsp-touchclick",function(){return aC?(aC=!1,!1):void 0})}function aX(){var aB=L(),aA=K();ai.removeClass("jspScrollable").unbind(".jsp"),aZ.unbind(".jsp"),ai.replaceWith(h.append(aZ.children())),h.scrollTop(aB),h.scrollLeft(aA),N&&clearInterval(N)}var aY,aZ,d,W,X,Y,Z,aa,ab,ac,ad,ae,af,j,ag,m,V,z,P,T,g,l,az,ar,O,S,f,k,u,al,N,R,e,i,p=this,ah=!0,M=!0,Q=!1,U=!1,h=ai.clone(!1,!1).empty(),n=a.fn.mwheelIntent?"mwheelIntent.jsp":"mousewheel.jsp";"border-box"===ai.css("box-sizing")?(R=0,e=0):(R=ai.css("paddingTop")+" "+ai.css("paddingRight")+" "+ai.css("paddingBottom")+" "+ai.css("paddingLeft"),e=(parseInt(ai.css("paddingLeft"),10)||0)+(parseInt(ai.css("paddingRight"),10)||0)),a.extend(p,{reinitialise:function(aA){aA=a.extend({},aY,aA),ak(aA)},scrollToElement:function(aB,aC,aA){J(aB,aC,aA)},scrollTo:function(aB,aC,aA){I(aB,aA),H(aC,aA)},scrollToX:function(aA,aB){I(aA,aB)},scrollToY:function(aA,aB){H(aA,aB)},scrollToPercentX:function(aA,aB){I(aA*(Y-d),aB)},scrollToPercentY:function(aA,aB){H(aA*(Z-W),aB)},scrollBy:function(aB,aC,aA){p.scrollByX(aB,aA),p.scrollByY(aC,aA)},scrollByX:function(aC,aD){var aA=K()+Math[0>aC?"floor":"ceil"](aC),aB=aA/(Y-d);D(aB*m,aD)},scrollByY:function(aC,aD){var aA=L()+Math[0>aC?"floor":"ceil"](aC),aB=aA/(Z-W);B(aB*af,aD)},positionDragX:function(aA,aB){D(aA,aB)},positionDragY:function(aA,aB){B(aA,aB)},animate:function(aE,aF,aA,aB,aC){var aD={};aD[aF]=aA,aE.animate(aD,{duration:aY.animateDuration,easing:aY.animateEase,queue:!1,step:aB,complete:aC})},getContentPositionX:function(){return K()},getContentPositionY:function(){return L()},getContentWidth:function(){return Y},getContentHeight:function(){return Z},getPercentScrolledX:function(){return K()/(Y-d)},getPercentScrolledY:function(){return L()/(Z-W)},getIsScrollableH:function(){return ad},getIsScrollableV:function(){return ac},getContentPane:function(){return aZ},scrollToBottom:function(aA){B(af,aA)},hijackInternalLinks:a.noop,destroy:function(){aX()}}),ak(aj)}return b=a.extend({},a.fn.jScrollPane.defaults,b),a.each(["arrowButtonSpeed","trackClickSpeed","keyboardSpeed"],function(){b[this]=b[this]||b.speed}),this.each(function(){var d=a(this),e=d.data("jsp");e?e.reinitialise(b):(a("script",d).filter('[type="text/javascript"],:not([type])').remove(),e=new c(d,b),d.data("jsp",e))})},a.fn.jScrollPane.defaults={showArrows:!1,maintainPosition:!0,stickToBottom:!1,stickToRight:!1,clickOnTrack:!0,autoReinitialise:!1,autoReinitialiseDelay:500,verticalDragMinHeight:0,verticalDragMaxHeight:99999,horizontalDragMinWidth:0,horizontalDragMaxWidth:99999,contentWidth:void 0,animateScroll:!1,animateDuration:300,animateEase:"linear",hijackInternalLinks:!1,verticalGutter:4,horizontalGutter:4,mouseWheelSpeed:3,arrowButtonSpeed:0,arrowRepeatFreq:50,arrowScrollOnHover:!1,trackClickSpeed:0,trackClickRepeatFreq:70,verticalArrowPositions:"split",horizontalArrowPositions:"split",enableKeyboardNavigation:!0,hideFocus:!1,keyboardSpeed:0,initialDelay:300,speed:30,scrollPagePercent:0.8}});$(document).ready(function(){$(".custom-scroll-bar-basic").jScrollPane({contentWidth:"0px"})});$(function(){var h=$(".file_upload"),j=h.find("input"),g=h.find("button"),i=h.find("div");g.focus(function(){j.focus()});j.focus(function(){h.addClass("focus")}).blur(function(){h.removeClass("focus")});var f=(window.File&&window.FileReader&&window.FileList&&window.Blob)?true:false;j.change(function(){var a;if(f&&j[0].files[0]){a=j[0].files[0].name}else{a=j.val().replace("C:\\fakepath\\","")}if(!a.length){return}if(i.is(":visible")){i.text(a);g.text("Выбрать")}else{g.text(a)}}).change()});$(window).resize(function(){$(".file_upload input").triggerHandler("change")})})();